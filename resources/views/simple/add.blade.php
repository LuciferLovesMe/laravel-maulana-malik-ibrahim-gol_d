...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{ route('simple.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col s12">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control" id="" placeholder="Masukkan deskripsi"></textarea>
                                    <div class=" materialize-red-text">
                                        @error('deskripsi')
                                        {{ $message }}
                                        @enderror
